...
¿Qué parte de la diferencia de las tasas se debe al cambio etario y cuál al cambio de los riesgos de morir? Siguiendo a Kitagawa en Partida(mimeo), tenemos:
...
>El primer sumando en el lado derecho, esto es, la diferencia de las estructuras etarias pon-
derada por el promedio de las tasas especÌÖcas, mide el efecto de la disimiltud en las com-
posiciones por edad; y el segundo, la diferencia de las pautas etarias de las tasas específicas ponderada por el promedio de las composiciones por edad de la población, da cuenta de la
diferencia en el riesgo medio de morir (Partida,2013:p.63).
